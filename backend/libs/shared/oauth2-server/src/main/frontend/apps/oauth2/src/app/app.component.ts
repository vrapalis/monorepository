...
import { OAUTH2_CODE_FLOW_CONFIG, SharedUtilEnvService } from '@frontend/shared/util';
...
export class AppComponent {
  ...
  constructor(private authService: OAuthService, private http: HttpClient, public envService: SharedUtilEnvService) {
